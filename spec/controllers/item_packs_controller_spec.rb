...
RSpec.describe ItemPacksController, type: :controller do
  ...
  # ItemPack. As you add validations to ItemPack, be sure to
  ...
  # ItemPacksController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all item_packs as @item_packs" do
      item_pack = ItemPack.create! valid_attributes
  ...
  describe "GET #show" do
    it "assigns the requested item_pack as @item_pack" do
      item_pack = ItemPack.create! valid_attributes
      get :show, params: {id: item_pack.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested item_pack as @item_pack" do
      item_pack = ItemPack.create! valid_attributes
      get :edit, params: {id: item_pack.to_param}, session: valid_session
      expect(assigns(:item_pack)).to eq(item_pack)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ItemPack" do
        expect {
          post :create, params: {item_pack: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved item_pack as @item_pack" do
        post :create, params: {item_pack: invalid_attributes}, session: valid_session
        expect(assigns(:item_pack)).to be_a_new(ItemPack)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested item_pack" do
        item_pack = ItemPack.create! valid_attributes
        put :update, params: {id: item_pack.to_param, item_pack: new_attributes}, session: valid_session
        item_pack.reload
      ...
      it "assigns the requested item_pack as @item_pack" do
        item_pack = ItemPack.create! valid_attributes
        put :update, params: {id: item_pack.to_param, item_pack: valid_attributes}, session: valid_session
        expect(assigns(:item_pack)).to eq(item_pack)
      end
    ...
    context "with invalid params" do
      it "assigns the item_pack as @item_pack" do
        item_pack = ItemPack.create! valid_attributes
        put :update, params: {id: item_pack.to_param, item_pack: invalid_attributes}, session: valid_session
        expect(assigns(:item_pack)).to eq(item_pack)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested item_pack" do
      item_pack = ItemPack.create! valid_attributes
      expect {
        delete :destroy, params: {id: item_pack.to_param}, session: valid_session
      }.to change(ItemPack, :count).by(-1)
    end
